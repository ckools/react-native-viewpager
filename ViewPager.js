...
import {Dimensions, View, PanResponder, Animated, StyleSheet} from 'react-native'
...
var ViewPager = React.createClass({
    ...
    movePage(step, gs) {
        ...
        if (gs === 0 || gs===false) {
            this.setState({scrollValue: new Animated.Value(scrollStep)}, (event) => {
                // if (event.finished) {
                    this.fling = false;
                    this.childIndex = nextChildIdx;
                    this.state.scrollValue.setValue(nextChildIdx);
